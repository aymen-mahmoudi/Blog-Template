...
tabs_dict = {'2D materials':['Intro','Basics','Graphene', 'TMDs'],
...
<body><div class="menu-bar"><a ref="#" class="logo">Classic blog template (by aymen mahmoudi)</a><ul><li class="active"><a href="..\index.html">Home</a></li>
"""
...
index_content = """
 <h1>Welcome to the classic blog's template</h1>
</div>

    <p>This is a sample to visualize the final output. I believe that this template is highly suitable for a scientific blog or a personal portfolio.
    <br>
    <br>
